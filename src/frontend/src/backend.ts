...
export class Backend implements backendInterface {
    ...
    async getDonationSubmissions(): Promise<Array<DonationSubmission>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDonationSubmissions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getVolunteerSignups(): Promise<Array<VolunteerSignup>> {
        if (this.processError) {
            try {
                const result = await this.actor.getVolunteerSignups();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitDonationForm(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: boolean, arg5: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitDonationForm(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitNewsletterSignup(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitNewsletterSignup(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitVolunteerSignup(arg0: string, arg1: string, arg2: string, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitVolunteerSignup(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
